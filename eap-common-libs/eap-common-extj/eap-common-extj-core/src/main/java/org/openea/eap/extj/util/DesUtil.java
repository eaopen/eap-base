...
public class DesUtil {
    ...
    private static String key = "org/openea/eap/extj";

    private static String SHORT_LINK_KEY = "extnlink";
    ...
    public static  String aesOrDecode(String res,boolean isEncode,boolean isAes){
        ...
        try {
            ...
            if(isEncode){
                ...
                byte[] result =parseHexStr2Byte(res);
                return new String(cipher.doFinal(result));
            }
        } catch (Exception e) {
//            throw new RuntimeException("秘钥解析错误");
        }
        return "";
    }
}
