...
public class JsonUtil {
    ...
    public static Map<String, Object> entityToMap(Object object, boolean writeMapNullValue){
        String jsonStr = null;
        if(writeMapNullValue){
            jsonStr = JSONObject.toJSONString(object, SerializerFeature.WriteMapNullValue);
        }else{
