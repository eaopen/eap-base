...
public class ReflectionUtil {
    ...
    public static RuntimeException convertReflectionExceptionToUnchecked(Exception e) {
        if (e instanceof IllegalAccessException || e instanceof IllegalArgumentException
            ...
            return new IllegalArgumentException("Reflection extn.exception.", e);
        } else if (e instanceof InvocationTargetException) {
            return new RuntimeException("Reflection extn.exception.", ((InvocationTargetException) e).getTargetException());
        } else if (e instanceof RuntimeException) {
            return (RuntimeException) e;
        }
        return new RuntimeException("Unexpected Checked extn.exception.", e);
    }
    ...
    public static String toString(final Object obj) {
        ...
        try {
            ...
            StringBuilder buf = new StringBuilder(obj.getClass().getName());
            buf.append(" [");
            // 获取所有成员变量
